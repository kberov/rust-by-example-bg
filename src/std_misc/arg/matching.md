...
Намиране на съвпадения може да бъде използвано за разбор на прости аргументи:
    ...
    match args.len() {
        ...
        3 => {
            ...
            match &cmd[..] {
                ...
                _ => {
                    eprintln!("Грешка: Нередовна команда!");
                    help();
                },
            }
        },
...
# Б. Пр.
[^разбор]: разбирам === правя разбор – parse
