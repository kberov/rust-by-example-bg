# Взаимодействие с чужди функции 

Ръждьо предоставя възможност за Взаимодействие с Чужди Функции (ВЧВ)[^FFI] за
...
[^FFI]: Взаимодействие с Чужди Функции (ВЧФ) – Foreign Function Interface
  (FFI). Приложно Програмно Взаимодействие (ППВ) – Application Programming
  Interface (API)
